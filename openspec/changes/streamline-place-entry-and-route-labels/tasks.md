...
- [x] 2.1 Normalize LS8H Transit API route labels to avoid numeric-only internal identifiers while retaining human-readable route names, and verify backend converter tests cover both cases.
